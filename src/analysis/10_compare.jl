...
sim = load("output/era5/ml_forced_10day_glorysinit_scaledx005_scaledy010_qt.jld2")
...
u_real = real["u_profiles"][10]
v_real = real["v_profiles"][10]
T_real = real["T_profiles"][10]
S_real = real["S_profiles"][10]

function rmse(a, b)
    sqrt(mean((a .- b).^2))
end

println("---- DAY 10 CHECK ----")
...
println("Compared against GLORYS day index = 10")