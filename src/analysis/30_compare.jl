...
sim = load("output/era5/ml_forced_30day_glorysinit_scaledx005_scaledy010_qt.jld2")
...
u_real = real["u_profiles"][30]
v_real = real["v_profiles"][30]
T_real = real["T_profiles"][30]
S_real = real["S_profiles"][30]

function rmse(a, b)
    sqrt(mean((a .- b).^2))
end

println("---- DAY 30 CHECK ----")
...
println("Compared against GLORYS day index = 30")