...
ml_enabled = Ref(true)
Rhat_abs_max_allowed  = 2e-4
Rhat_mean_abs_allowed = 2e-5

model_path = "data/generated/mlp_multicase_model.jld2"

outdir = "output/multicase/mlclosure_mlp_tx$(tx)_24hr_Nz128"
...
# load model
# -----------------------------
@info "Loading multicase MLP model" model_path=model_path
...
@info "Multicase MLP params loaded"
...
@info "Running multicase MLP closure sim" outdir=outdir tx=tx tau_relax=tau_relax
run!(simulation)
@info "Done"